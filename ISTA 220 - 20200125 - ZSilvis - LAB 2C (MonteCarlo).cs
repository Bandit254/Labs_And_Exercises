...
namespace ISTA220___20200125___ZSilvis___LAB_2C__Monte_Carlo_Method_
{
    class Program
    {
        ...
        public static double PiEstimator(int iterations)
        {
            ...
            return piEstimate = (overlapCounter / iterations) * 4;
        }
        ...
        static void Main(string[] args)
        {
            ...
            double piDiff = PiDiff(piEstimate);
            Console.WriteLine($"\nThe estimate of PI after {iterations} iterations is {piEstimate}, while the difference between the estimate and real PI is {piDiff}.");
